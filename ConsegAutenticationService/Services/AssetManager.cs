...
namespace ConsegAutenticationService.Services
{
    internal class AssetManager
    {
        ...
        //constants
        //public const string HttpAssetsNamespace = "ConsegAutenticationService.Services.DefaultViewService.HttpAssets";
        //public const string FontAssetsNamespace = HttpAssetsNamespace + ".libs.bootstrap.fonts";

        public const string PageAssetsNamespace = "ConsegAutenticationService.Services.DefaultViewService.PageAssets";
